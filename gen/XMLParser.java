...
public class XMLParser extends Parser {
	...
	public static final int
		RULE_document = 0, RULE_element = 1, RULE_attribute = 2, RULE_value = 3, 
		RULE_textContent = 4;
	private static String[] makeRuleNames() {
		return new String[] {
			"document", "element", "attribute", "value", "textContent"
		};
	}
	...
	public static class TextContentContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof XMLListener ) ((XMLListener)listener).enterTextContent(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof XMLListener ) ((XMLListener)listener).exitTextContent(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof XMLVisitor ) return ((XMLVisitor<? extends T>)visitor).visitTextContent(this);
			else return visitor.visitChildren(this);
		}
	}
